...
Revision ID: 2ab77548c1a8
Revises: 56a31a1c74ef
Create Date: 2026-03-25 13:29:16.844879
...
def upgrade() -> None:
    ...
    sa.UniqueConstraint('netsuite_id', 'product_id', 'supplier_id', name='uq_product_supplier_order_line')
    )
    op.create_index(op.f('ix_product_suppliers_netsuite_id'), 'product_suppliers', ['netsuite_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_product_suppliers_netsuite_id'), table_name='product_suppliers')
