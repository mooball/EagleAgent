...
class NetSuiteClient:
    ...
    def update_record(self, record_type: str, record_id: str, data: dict, params: dict | None = None) -> None:
        ...
        Args:
            ...
            params: Optional query params (e.g. {"replace": "itemVendor"} for
                sublist replacement semantics).
        ...
        response = self._session.patch(url, headers=headers, json=data, params=params, timeout=_DEFAULT_TIMEOUT)
        if not response.ok:
            logger.error(
